...
_MAKER_RE = re.compile(
    r"^(Фирма|Фабрика|Мастерская|Живописная мастерская|Мастер|Мастер-монограммист"
    r"|Неизвестн\w+|Автор|Иконописец|Исполнител\w*|Художник\w*|Миниатюрист|Скульптор\w*"
    r"|Медальер|Гравер|Резчик|Живописец|Императорск\w+|Национальн\w+|Частн\w+|Завод"
    r"|Серебряное заведение|Торгово-промышленное заведение|Товарищество|Монета"
    r"|Перв\w+|Втор\w+|Треть\w+|Четверт\w+|Пят\w+|Шест\w+|Седьм\w+|Восьм\w+|Девят\w+"
    r"|Десят\w+|Одиннадцат\w+|Двенадцат\w+|Тринадцат\w+|Четырнадцат\w+|Пятнадцат\w+"
    r"|Шестнадцат\w+|Семнадцат\w+|Восемнадцат\w+|Девятнадцат\w+|Двадцат\w+)\b"
)
